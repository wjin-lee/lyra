 ...
 * }</pre>
 * <p>
 * To process the result the receiving activity ({@code MainActivity} in this owl) needs to override one of its
...
public class AuthorizationClient {
    ...
    interface AuthorizationClientListener {
         ...
         * for owl because of underlying LoginActivity was paused or stopped.
